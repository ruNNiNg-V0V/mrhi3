				...
				<legend><p>강습예약</p></legend>
					<p>
					 <select name="person" id="person">
					 	...
					 	<option value="80000">1</option>
					 	<option value="160000">2</option>
					 	<option value="240000">3</option>
					 	<option value="320000">4</option>
					 	<option value="400000">5</option>
					 	<option value="480000">6</option>
					 	<option value="560000">7</option>
					 	<option value="640000">8</option>
					 	<option value="720000">9</option>
					 </select>
				</p>
				<p>
