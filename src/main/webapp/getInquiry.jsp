			...
			<div class="box3">
				...
				<div class="content">
					<form action="updateInquiry.do" method="post">
						<input name="seq" type="hidden" value="${inquiry.seq}" />
					...
					<div style="text-align: center;">
						<style>
						.qnaBoardBtn {width: 30%;height: 50%;cursor: pointer;
									color: white;background-color: #122639;}
						</style>
						<button class="qnaBoardBtn"
							onclick="confirmBtn('updateInquiry.do', '수정하시겠습니까?');">글수정</button>
						&nbsp;&nbsp;&nbsp;
						<button class="qnaBoardBtn"
							onclick="confirmBtn('deleteInquiry.do?seq=${inquiry.seq}', '삭제하시겠습니까?');">글삭제</button>
						&nbsp;&nbsp;&nbsp;
						<button class="qnaBoardBtn"
							onclick="window.location.href='getInquiryList.do';">글목록</button>
